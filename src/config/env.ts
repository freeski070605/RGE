...
const envSchema = z.object({
  ...
  MEDIA_WORKER_CONCURRENCY: z.coerce.number().default(1),
  ...
  MEDIA_JOB_LOCK_DURATION_MS: z.coerce.number().default(5 * 60 * 1000),
  MEDIA_JOB_STALLED_INTERVAL_MS: z.coerce.number().default(60 * 1000),
  MEDIA_JOB_MAX_STALLED_COUNT: z.coerce.number().default(2),
